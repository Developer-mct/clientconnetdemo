            ...
            {rows.length > 0 ? (
              <CardGroup className="main-container">
                <Card className="l-container extra-con" style={{ fontFamily: "Poppins", borderRadius: "10px", backgroundColor: "#C6A780" }}>
                  <CardBody>
                    ...
                    <div className="container pos">
                      <Typography variant="body2" component="p" style={{ marginBottom: "4px", fontSize: "30px", fontFamily: 'Poppins' }}>
                ...
                <Card className="l-container" style={{
                  ...
                  <CardBody>
                    <img src="/Subscription/handcuffs.svg" alt="handcuff" className="png tileicon" />
                    <div className="container pos2">
                      <span style={{ fontWeight: "bold", fontSize: "16px", fontFamily: "Poppins", lineHeight: "20px" }}>
                        Top Charge
                      </span>

                      {charge.map((row, i) => (
                        <div key={i} className="chargeTile" >
                          <span style={{ fontSize: "15px", }}>
                            <span style={{ paddingLeft: "0px", letterSpacing: "1px", fontFamily: "Poppins", fontWeight: 500 }}>

                        ...
                        <Row form>
                            <Col md={12}>
                                ...
                                <InputGroup className="mb-3">
                                    ...
                                    <Input innerRef={register} type="text" name="cName" placeholder="Name on card" required />
                            ...
                            <Col md={12}>
                                ...
                                <InputGroup className="mb-3">
                                    ...
                                    <Input innerRef={register} type="tel" inputMode="numeric" name="cNo" id="cNo" onChange={(event) => {
                        ...
                        <Row form>
                            ...
                            <Col md={12}>
                                ...
                                <InputGroup className="mb-3">
                                    ...
                                    <Input innerRef={register} type="text" name="cvv" id="exampleCity" placeholder="----" required />

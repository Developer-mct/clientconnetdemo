        ...
        return (
            ...
            <div className="MailChampEdit">
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <h1 style={{ textAlign: 'center', padding: '10px' }}>Edit your Template</h1>
                    <button onClick={handleSubmit}  style={{ width: "80px", marginTop: '10px', fontSize: '15px',border:'none',height:'40px',borderRadius:'10px',backgroundColor:'#c2c0ba' }}>save</button>
                    {/* <button onClick={addmore} style={{ marginLeft:'10px', width: "100px", height: '40px', marginTop: '6px', fontSize: '15px' }}>add more</button> */}
                </div>
...
//     const [content2, setContent2] = useState("If not, dont worry – ________Attorney at Law is here to help. You need a seasoned law firm that is going to care about you and the fight you are in. Weve represented people in your position, and worse, for __ years.");
...
//                 <div style={{ display: 'flex', justifyContent: 'center' }}>
//                     <h1 style={{ textAlign: 'center', padding: '10px' }}>Edit your Template</h1>
//                     <button onClick={handleSubmit} style={{ width: "80px", height: '40px', marginTop: '6px', fontSize: '15px' }}>save</button>
//                     {/* <button onClick={addmore} style={{ marginLeft:'10px', width: "100px", height: '40px', marginTop: '6px', fontSize: '15px' }}>add more</button> */}
//                 </div>
